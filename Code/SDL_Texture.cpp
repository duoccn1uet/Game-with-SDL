...
int main(int argc, char* argv[])
{
    ...
    SDL_Texture* tree = loadTexture("tree.jpg", renderer);
    SDL_Rect tree_rect;
    SDL_QueryTexture(tree, nullptr, nullptr, &tree_rect.w, &tree_rect.h);
    tree_rect.x = tree_rect.y = 100;
    tree_rect.w /= 3;
    tree_rect.h /= 3;
    SDL_RenderCopy(renderer, tree, nullptr, &tree_rect);
    /**
        RenderCopy explain:
